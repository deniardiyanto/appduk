  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <h2>Data Kritik dan Saran</h2><hr>
        <div align="center">
          <form method="get" action="">
            ...
            <a href="<?php echo base_url('admin/lap_kritik'); ?>">Reset Filter</a>
          </form>
          <hr /></th></tr>

          <b><?php echo $ket; ?></b>
          <a href="<?php echo $url_cetak; ?>"><button class="btn btn-danger"><strong>CETAK PDF <span class="fa fa-print"></span></strong></button></a></div><br>
